        ...
        styleSheet.textContent = `
            @media print {
                #living-archive-info p:last-of-type:after {
                    content: "\\0A \\0A This digital document (Version 2.8) was generated on ${safeDate}. Verify against primary archival sources if critical.";
                }
            }
        `;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (translateBtnConst) {
            ...
            translateBtnConst.setAttribute('aria-expanded', 'false');
             if (!translateBtnConst.innerHTML.includes(hideHtmlTranslate.substring(0,20)) && !translateBtnConst.innerHTML.includes(loadingHtmlTranslate.substring(0,20))) {
